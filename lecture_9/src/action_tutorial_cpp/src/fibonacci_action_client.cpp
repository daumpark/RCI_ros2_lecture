...
#include "action_tutorial_interfaces/action/fibonacci.hpp"
...
{
public:
    using Fibonacci = action_tutorial_interfaces::action::Fibonacci;
...
private:
    ...
    void goal_response_callback(const GoalHandleFibonacci::SharedPtr &goal_handle)
    {
        if (!goal_handle) {
            ...
            RCLCPP_INFO(this->get_logger(), "Goal accepted by server, waiting fo result");
        }
    }
